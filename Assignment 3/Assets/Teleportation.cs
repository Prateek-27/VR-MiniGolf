...
public class Teleportation : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log(inputAction.FindActionMap("XRI " + targetController.ToString() + " Locomotion").actions.Count);
        Debug.Log(inputAction.actionMaps.Count);
